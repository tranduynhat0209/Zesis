...
export class ServiceRouter {
  ...
  public route() {
     ...
     *         isContract:
     *           type: boolean
     *           description: If enabled, the service will run on blockchain
     *         requirements:
     *           items:
     *             $ref: '#/components/schemas/Requirement'
     *       required:
    ...
    this.router.put(
      "/:serviceId/active",
      new ServiceController().toggleServiceActive
    );
     ...
     *     security:
     *       - Authorization: []
     *     summary: Sync queries on MultiServiceContract to match with data in the database
     *     description: Sync multi queries 
     *     tags:
     *       - Service
     *     requestBody:
     *       description: A specific network Id
     *       required: true
     *       content:
     *         application/json:
     *           schema:
     ...
     *     responses:
     *       '200':
     *         description: A Services synced announcement
     *         content:
     *           application/json:
     *             schema:
     *              type: object
     ...
     *                   example: Error message
     */
    this.router.post("/sync", new ServiceController().syncWeb3Services);
  }
}
